...
class CurveDataPoints(BaseModel):
    ...
    """ # noqa: E501
    channel: StrictInt
    temperatures: List[Union[StrictFloat, StrictInt]] = Field(description="List of temperature values")
    sensors: List[Union[StrictFloat, StrictInt]] = Field(description="List of sensor values")
    __properties: ClassVar[List[str]] = ["channel", "temperatures", "sensors"]
