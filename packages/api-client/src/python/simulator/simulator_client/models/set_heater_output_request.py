...
class SetHeaterOutputRequest(BaseModel):
    """
    SetHeaterOutputRequest
    """ # noqa: E501
    value: Union[Annotated[float, Field(le=1, strict=True, ge=0)], Annotated[int, Field(le=1, strict=True, ge=0)]] = Field(description="Heater output level (0.0 to 1.0)")
