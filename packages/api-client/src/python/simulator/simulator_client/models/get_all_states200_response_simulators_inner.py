...
class GetAllStates200ResponseSimulatorsInner(BaseModel):
    """
    GetAllStates200ResponseSimulatorsInner
    """ # noqa: E501
    config: GetAllStates200ResponseSimulatorsInnerConfig
    state: List[List[Union[StrictFloat, StrictInt]]]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "config": GetAllStates200ResponseSimulatorsInnerConfig.from_dict(obj["config"]) if obj.get("config") is not None else None,
            "state": obj.get("state")
        })
        return _obj
